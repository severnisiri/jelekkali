...
this.body.toggleClass(this.classes.isOverlay),
a.toggleClass(this.classes.toggled),
this.body.hasClass(this.classes.headerSidebarActive) ?  c.focus(): a.focus(),
...
c.after('<div class="dt-row dt-text-center dt-mt-5" style="align-items: center;"><div class="dt-col-12"><a href="javascript:void(0);" data-title="' + b.textBtn + '" class="dt-btn dt-btn-primary dt-btn-loadmore ' +
b.classBtn +
'">' +
b.textBtn +
"</a></div></div>"
