 ...
 */
function newsmash_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function newsmash_sanitize_html( $html ) {
 ...
 */
function newsmash_sanitize_select( $input, $setting ) {
 ...
 */
function newsmash_sanitize_url( $url ) {
	return esc_url_raw( $url );
}


/* Sanitization Text*/
function newsmash_sanitize_text( $text ) {
	return wp_filter_post_kses( $text );
}

/* Sanitization Integer*/
function newsmash_sanitize_integer( $input ) {
    if( is_numeric( $input ) ) {
        return intval( $input );
    }
}