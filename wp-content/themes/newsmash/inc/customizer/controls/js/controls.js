...
( function( api ) {
	...
	// Extends our custom "newsmash" section.
	api.sectionConstructor['newsmash'] = api.Section.extend( {
...
jQuery(document).ready(function($) {
	 jQuery("#sub-accordion-section-newsmash_typography_options select, #sub-accordion-section-newsmash_headings_typography select").prop('disabled', true);
});