(function ($) {
    ...
    wp.newsmashcustomizerRepeater = {
        ...
        init: function () {
            $('.iconpicker-items>i').on('click', function () {
                ...
                newsmash_customizer_repeater_refresh_social_icons(th);
                return false;
            });
        },
    ...
    $(document).ready(function () {
        wp.newsmashcustomizerRepeater.init();

        $('.iconpicker-search').on('keyup', function () {
            wp.newsmashcustomizerRepeater.search($(this));
        });

        $('.icp-auto').on('click', function () {
            wp.newsmashcustomizerRepeater.iconPickerToggle($(this));
        });
