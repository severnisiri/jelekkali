/* global jQuery */
/* global wp */
function newsmash_media_upload(button_class) {
    'use strict';
 ...
 *** Generate unique id ***
 *********************************************/
function newsmash_customizer_repeater_uniqid(prefix, more_entropy) {
    'use strict';
 ...
 *** General Repeater ***
 *********************************************/
function newsmash_customizer_repeater_refresh_social_icons(th) {
    'use strict';
    ...
    th.find('.customizer-repeater-social-repeater-container').each(function () {
        ...
        if (!id) {
            id = 'customizer-repeater-social-repeater-' + newsmash_customizer_repeater_uniqid();
    ...
    newsmash_customizer_repeater_refresh_general_control_values();
}


function newsmash_customizer_repeater_refresh_general_control_values() {
    'use strict';
    jQuery('.customizer-repeater-general-control-repeater').each(function () {
        ...
        th.find('.customizer-repeater-general-control-repeater-container').each(function () {
            ...
            if (!id) {
                id = 'social-repeater-' + newsmash_customizer_repeater_uniqid();
            ...
            if (text !== '' || image_url !== '' || image_url2 !== '' || title !== '' || subtitle !== '' || icon_value !== '' || link !== '' || choice !== '' || social_repeater !== '' || shortcode !== '' || slide_align !== ''  || bg_type !== '' || color !== '') {
                values.push({
                    ...
                    'color': color,
                    'color2': color2,
                    'text': newsmashescapeHtml(text),
                    'link': link,
                    'text2': newsmashescapeHtml(text2),
					'button_second': newsmashescapeHtml(button_second),
                    'link2': link2,
					'link3': link3,
                    'image_url': (choice === 'customizer_repeater_none' ? '' : image_url),
                    'choice': choice,
                    'image_url2': image_url2,
                    'title': newsmashescapeHtml(title),
                    'subtitle': newsmashescapeHtml(subtitle),
					'subtitle2': newsmashescapeHtml(subtitle2),
					'subtitle3': newsmashescapeHtml(subtitle3),
					'subtitle4': newsmashescapeHtml(subtitle4),
					'subtitle5': newsmashescapeHtml(subtitle5),
					'video_url': newsmashescapeHtml(video_url),
					'slide_align': newsmashescapeHtml(slide_align),
					'bg_type': newsmashescapeHtml(bg_type),
					'open_new_tab' : open_new_tab,
                    'social_repeater': newsmashescapeHtml(social_repeater),
                    'id': id,
                    'shortcode': newsmashescapeHtml(shortcode)
                });
            }
...
jQuery(document).ready(function () {
    'use strict';
    var newsmash_theme_controls = jQuery('#customize-theme-controls');
    newsmash_theme_controls.on('click', '.customizer-repeater-customize-control-title', function () {
    ...
    newsmash_theme_controls.on('change', '.icp',function(){
        newsmash_customizer_repeater_refresh_general_control_values();
        return false;
    });
	
	newsmash_theme_controls.on('change','.customizer-repeater-slide-align', function(){
		newsmash_customizer_repeater_refresh_general_control_values();
        return false;
		
	});
	
	newsmash_theme_controls.on('change','.customizer-repeater-bg-type', function(){
		newsmash_customizer_repeater_refresh_general_control_values();
        return false;
		
	});

    newsmash_theme_controls.on('change','.customizer-repeater-image2-control', function(){
        newsmash_customizer_repeater_refresh_general_control_values();
        return false;
        
    });
	
    newsmash_theme_controls.on('change', '.customizer-repeater-image-choice', function () {
    ...
    newsmash_media_upload('.customizer-repeater-custom-media-button');
     ...
     *
     */
    newsmash_theme_controls.on('click', '.customizer-repeater-new-field', function () {		
		var th = jQuery(this).parent();
        var id = 'customizer-repeater-' + newsmash_customizer_repeater_uniqid();
		var parentid = jQuery(this).parent().attr("id");
		
		if(parentid == 'customize-control-newsmash_hdr_social')
		{	
			var totalItems = jQuery("#customize-control-newsmash_hdr_social .customizer-repeater-general-control-repeater-container").length 
			if(totalItems >= 4){
			  jQuery( "#customize-control-newsmash_social_option_upsale .desert-companion-upgrade-message" ).show();
			  return false;   
			}
		}
		
		if(parentid == 'customize-control-newsmash_footer_copyright_social')
		{	
			var totalItems = jQuery("#customize-control-newsmash_footer_copyright_social .customizer-repeater-general-control-repeater-container").length 
			if(totalItems >= 4){
			  jQuery( "#customize-control-newsmash_social_option_upsale .desert-companion-upgrade-message" ).show();
			  return false;   
			}
    ...
    newsmash_theme_controls.on('click', '.social-repeater-general-control-remove-field', function () {
        ...
        if (typeof    jQuery(this).parent() !== 'undefined') {
            jQuery(this).parent().hide(500, function(){
				...
				var newsmash_hdr_social = jQuery("#customize-control-newsmash_hdr_social .customizer-repeater-general-control-repeater-container").length 
				if(newsmash_hdr_social < 4){ 
				  jQuery( "#customize-control-newsmash_social_option_upsale .desert-companion-upgrade-message" ).hide();
				}
				
				var newsmash_footer_copyright_social = jQuery("#customize-control-newsmash_footer_copyright_social .customizer-repeater-general-control-repeater-container").length 
				if(newsmash_footer_copyright_social < 4){ 
				  jQuery( "#customize-control-newsmash_social_option_upsale .desert-companion-upgrade-message" ).hide();
				}
            });
        }
    ...
    newsmash_theme_controls.on('keyup', '.customizer-repeater-title-control', function () {
        newsmash_customizer_repeater_refresh_general_control_values();
    });
    ...
    newsmash_theme_controls.on('keyup', '.customizer-repeater-subtitle-control', function () {
        newsmash_customizer_repeater_refresh_general_control_values();
    });
	
	 newsmash_theme_controls.on('keyup', '.customizer-repeater-subtitle2-control', function () {
        newsmash_customizer_repeater_refresh_general_control_values();
    });
	
	newsmash_theme_controls.on('keyup', '.customizer-repeater-subtitle3-control', function () {
        newsmash_customizer_repeater_refresh_general_control_values();
    });
	
	newsmash_theme_controls.on('keyup', '.customizer-repeater-subtitle4-control', function () {
        newsmash_customizer_repeater_refresh_general_control_values();
    });
	
	newsmash_theme_controls.on('keyup', '.customizer-repeater-subtitle5-control', function () {
        newsmash_customizer_repeater_refresh_general_control_values();
    });
	
	newsmash_theme_controls.on('keyup', '.customizer-repeater-video-url-control', function () {
        newsmash_customizer_repeater_refresh_general_control_values();
    });

    newsmash_theme_controls.on('keyup', '.customizer-repeater-shortcode-control', function () {
        newsmash_customizer_repeater_refresh_general_control_values();
    });

    newsmash_theme_controls.on('keyup', '.customizer-repeater-text-control', function () {
        newsmash_customizer_repeater_refresh_general_control_values();
    });

    newsmash_theme_controls.on('keyup', '.customizer-repeater-link-control', function () {
        newsmash_customizer_repeater_refresh_general_control_values();
    });

    newsmash_theme_controls.on('keyup', '.customizer-repeater-text2-control', function () {
        newsmash_customizer_repeater_refresh_general_control_values();
    });
	
	newsmash_theme_controls.on('keyup', '.customizer-repeater-button2-control', function () {
        newsmash_customizer_repeater_refresh_general_control_values();
    });

    newsmash_theme_controls.on('keyup', '.customizer-repeater-link2-control', function () {
        newsmash_customizer_repeater_refresh_general_control_values();
    });
	
	newsmash_theme_controls.on('keyup', '.customizer-repeater-link3-control', function () {
        newsmash_customizer_repeater_refresh_general_control_values();
    });
	
	newsmash_theme_controls.on('change','.customizer-repeater-checkbox', function(){
    ...
    /*----------------- Socials Repeater ---------------------*/
    newsmash_theme_controls.on('click', '.social-repeater-add-social-item', function (event) {
        event.preventDefault();
        var th = jQuery(this).parent();
        var id = 'customizer-repeater-social-repeater-' + newsmash_customizer_repeater_uniqid();
        if (typeof th !== 'undefined') {
    ...
    newsmash_theme_controls.on('click', '.social-repeater-remove-social-item', function (event) {
        event.preventDefault();
        var th = jQuery(this).parent();
        var repeater = jQuery(this).parent().parent();
        th.remove();
        newsmash_customizer_repeater_refresh_social_icons(repeater);
        return false;
    });

    newsmash_theme_controls.on('keyup', '.customizer-repeater-social-repeater-link', function (event) {
        event.preventDefault();
        var repeater = jQuery(this).parent().parent();
        newsmash_customizer_repeater_refresh_social_icons(repeater);
        return false;
    ...
    newsmash_theme_controls.on('change', '.customizer-repeater-social-repeater-container .icp', function (event) {
        event.preventDefault();
...
function newsmashescapeHtml(string) {
    'use strict';
    //noinspection JSUnresolvedFunction
    string = String(string).replace(new RegExp('\r?\n', 'g'), '<br />');
    string = String(string).replace(/\\/g, '&#92;');
    return String(string).replace(/[&<>"'\/]/g, function (s) {
        return newsmashentityMap[s];
    });
